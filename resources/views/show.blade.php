    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                ...
                <div class="text-gray-400">
                    ...
                    <span>
                        @foreach($game['involved_companies'] as $company)
                            @if( array_key_exists('company', $company))
                ...
                <div class="mt-12">
                    <a href="https://www.youtube.com/watch?v={{ $game['videos'][0]['video_id'] }}" class="inline-flex bg-blue-500 hover:bg-blue-600 text-white font-semibold px-4 py-4 rounded transition ease-in-out duration-150">
        ...
        <div class="images-container border-b border-gray-800 pb-12 mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                @foreach($game['screenshots'] as $screenshot)
                    <div>
                        <a href="#">
                            <img src="{{ Str::replaceFirst('thumb', 'screenshot_med', $screenshot['url']) }}" alt="screenshot" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
                    </div>
                @endforeach
            </div>
