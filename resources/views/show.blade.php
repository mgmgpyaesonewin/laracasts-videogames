    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            ...
            <div class="lg:ml-12 lg:mr-64">
                ...
                <div class="mt-12">
                    <a href="{{ $game['trailerVideo'] }}" class="inline-flex bg-blue-500 hover:bg-blue-600 text-white font-semibold px-4 py-4 rounded transition ease-in-out duration-150">
                 ...
                 @foreach($game['similarGames'] as $similar_game)
                    <div class="game mt-8">
                        <div class="relative inline-block">
                                <a href="{{ $similar_game['coverImageUrl'] }}">
                                    <img src="{{ $similar_game['coverImageUrl'] }}" alt="game cover"
